...
class MessagingCommonContractTest {
  ...
  void producerImplementationReceivesTheMappedDestinationAndNormalizedEnvelope() {
    RecordingMessageProducerImplementation implementation =
        new RecordingMessageProducerImplementation();
  ...
  void consumerImplementationReceivesMappedChannelsAndKeepsIdentitiesSeparate() {
    ControllableMessageConsumerImplementation implementation =
        new ControllableMessageConsumerImplementation();
  ...
  void decoratorOrderingIsNumericAndNotRegistrationOrder() {
    ...
    chain.invokeNext(new MessageHandlerInvocation(
        MessageFixtures.message(), new MessageContext("subscriber", "orders", 1)));
