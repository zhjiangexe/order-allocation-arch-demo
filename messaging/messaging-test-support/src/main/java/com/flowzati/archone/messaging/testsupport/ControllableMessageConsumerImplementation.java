...
public final class ControllableMessageConsumerImplementation implements MessageConsumerImplementation {
    ...
    public void emit(String subscriberId, String destination, Message message, int processingAttempt) {
    ...
    private record Registration(
            ResolvedMessageSubscription subscription, MessageHandler handler, TestSubscription handle) {}
