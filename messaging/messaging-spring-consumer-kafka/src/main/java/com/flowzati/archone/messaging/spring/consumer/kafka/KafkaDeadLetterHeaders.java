...
public final class KafkaDeadLetterHeaders {
  ...
  public static final String ORIGINAL_LOGICAL_CHANNEL =
      "archone-dlt-original-logical-channel";
  public static final String ORIGINAL_PHYSICAL_DESTINATION =
      "archone-dlt-original-physical-destination";
