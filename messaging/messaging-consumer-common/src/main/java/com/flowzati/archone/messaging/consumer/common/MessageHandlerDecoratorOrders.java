 ...
 * idempotency must wrap protocol dispatch and the application handler. An application-specific
 * attempt policy may use the reserved outer range when every retry must open a new transaction.
 */
