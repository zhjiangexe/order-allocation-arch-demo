...
public final class IntegrationEventDispatcherFactory {
    ...
    public IntegrationEventDispatcher make(String subscriberId, IntegrationEventHandlers handlers) {
        ...
        IntegrationEventDispatcher dispatcher =
                new IntegrationEventDispatcher(deserializer, handlers, nameMapping, unhandledEventObserver);
        MessageSubscription subscription = messageConsumer.subscribe(subscriberId, handlers.destinations(), dispatcher);
