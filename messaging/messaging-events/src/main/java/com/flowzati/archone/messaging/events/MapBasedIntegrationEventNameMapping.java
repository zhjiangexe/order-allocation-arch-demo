...
public final class MapBasedIntegrationEventNameMapping implements IntegrationEventNameMapping {
  ...
  @Override
  public IntegrationEventType externalTypeFor(
    ...
    if (externalType == null) {
      throw new IllegalArgumentException(
          "Unmapped Integration Event class: " + eventClass.getName());
    }
    return externalType;
  }

  @Override
  public Optional<Class<? extends IntegrationEvent>> eventClassFor(
  ...
  public static final class Builder {
    ...
    public <E extends IntegrationEvent> Builder map(
        Class<E> eventClass,
        String eventType,
        int contractVersion
    ) {
      ...
      if (externalTypes.containsKey(eventClass)) {
        throw new IllegalStateException(
            "Duplicate Integration Event class mapping: " + eventClass.getName());
      }
      Class<? extends IntegrationEvent> existingClass = eventClasses.get(externalType);
      if (existingClass != null) {
        throw new IllegalStateException("Duplicate Integration Event type mapping: "
