...
public record OutboxMessage(
  ...
  public OutboxMessage {
    if (messageId == null || aggregateType == null || aggregateId == null || createdAt == null
        || serializedHeaders == null || isBlank(messageType) || isBlank(destination)
        || isBlank(partitionKey) || isBlank(payload)) {
