...
class JacksonMessageHeadersCodecTest {
  ...
  void rejectsOversizedAndNonStringHeaderMaps() {
    JacksonMessageHeadersCodec countLimited = new JacksonMessageHeadersCodec(
        new ObjectMapper(), Set.of(), 1, 100);
    JacksonMessageHeadersCodec byteLimited = new JacksonMessageHeadersCodec(
        new ObjectMapper(), Set.of(), 10, 8);
