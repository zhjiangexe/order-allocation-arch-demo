...
class MessageSubscriptionOptionsTest {
  ...
  void defaultsTheConsumerGroupToTheStableSubscriberId() {
    ...
    assertThat(options.resolveConsumerGroupId("stock-allocation"))
        .isEqualTo("stock-allocation");
  }
  ...
  void keepsAnExplicitConsumerGroupSeparate() {
    ...
    assertThat(options.resolveConsumerGroupId("stock-allocation-inbox"))
        .isEqualTo("stock-allocation-kafka");
  }
