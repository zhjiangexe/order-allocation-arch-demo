...
-- The consumer starter owns the transaction algorithm; this deployable owns its Inbox table.
...
CREATE INDEX idx_wms_event_inbox_event_id ON event_inbox (event_id);
