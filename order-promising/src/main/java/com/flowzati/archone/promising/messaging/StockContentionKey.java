 ...
 *
 * <p>這是 order-promising 的訊息政策，不是跨應用 foundation。集中在 promising package，是因為
 * ordering translator 與庫存可用性 translator **必須產生逐位元相同的 key**；各自複製會讓
 * single-writer 保證在沒有錯誤訊息的情況下失效。
 */
