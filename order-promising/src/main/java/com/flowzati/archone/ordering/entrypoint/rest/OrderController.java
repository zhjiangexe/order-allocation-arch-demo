...
public class OrderController {
    ...
    @GetMapping
    public List<OrderStatusResponse> listRecentOrders(@RequestParam(defaultValue = "" + DEFAULT_LIMIT) int limit) {
    ...
    public ResponseEntity<String> handleIntegrityViolation(DataIntegrityViolationException e) {
        ...
        return ResponseEntity.badRequest().body("The order references catalog data that does not exist for this owner");
    }
