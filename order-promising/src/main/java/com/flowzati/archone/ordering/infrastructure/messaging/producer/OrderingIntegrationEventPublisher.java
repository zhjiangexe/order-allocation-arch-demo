...
/**
 * Producer-side adapter from Ordering domain facts to external Integration Events.
 * It is called directly by the use case and is not a Spring {@code @EventListener}.
 */
@Component
public class OrderingIntegrationEventPublisher implements OrderingDomainEventPublisher {

  private static final String STOCK_STRATEGY = "stock";
  private static final Logger log = LoggerFactory.getLogger(OrderingIntegrationEventPublisher.class);

  private final IntegrationEventPublisher eventPublisher;
  private final String partitionKeyStrategy;

  public OrderingIntegrationEventPublisher(
