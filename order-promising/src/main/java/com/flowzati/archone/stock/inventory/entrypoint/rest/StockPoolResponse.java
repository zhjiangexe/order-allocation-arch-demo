 ...
 */
public record StockPoolResponse(List<SkuStockResponse> skus) {

  static StockPoolResponse from(Map<String, List<StockPool>> batchesBySku, LocalDate today) {
  ...
  public record SkuStockResponse(String sku, List<StockBatchResponse> batches) {
    ...
    static SkuStockResponse from(String sku, List<StockPool> batches, LocalDate today) {
