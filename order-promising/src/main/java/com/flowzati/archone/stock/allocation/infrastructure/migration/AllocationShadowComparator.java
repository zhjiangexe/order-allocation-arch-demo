...
public final class AllocationShadowComparator {
  ...
  public record LegacySnapshot(
    ...
    public LegacySnapshot {
      ...
      Objects.requireNonNull(configuredOutboundLocationId,
          "Configured outbound location is required");
      lines = canonicalLines(lines);
    }

    public UUID normalizedLocationId() {
      return existingExecutionLocationId == null
          ? configuredOutboundLocationId
          : existingExecutionLocationId;
    }
  }
    ...
    public DemandSnapshot {
      ...
      if (allocationEligible && rejectedOnlyByCrossSkuPredecessor) {
        throw new IllegalArgumentException(
            "An eligible demand cannot be rejected by cross-SKU precedence");
      }
    }
  }
