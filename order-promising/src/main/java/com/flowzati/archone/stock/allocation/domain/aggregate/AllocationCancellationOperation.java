package com.flowzati.archone.stock.allocation.domain.aggregate;
...
public final class AllocationCancellationOperation {
  ...
  private AllocationCancellationOperation(
    ...
    if (allocationDemandId == null || operationId == null || startedAt == null
  ...
  public static AllocationCancellationOperation start(
      UUID allocationDemandId, UUID operationId, Instant startedAt) {
    return new AllocationCancellationOperation(
        allocationDemandId, operationId, startedAt, startedAt,
        AllocationCancellationState.STARTED, null);
  }
