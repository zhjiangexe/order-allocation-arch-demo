...
public class AllocationKafkaIntegrationEventConsumer {
  ...
  @KafkaListener(
      id = AllocationEventSubscriptions.ORDER_LIFECYCLE,
      topics = OrderingEventTopics.ORDER_EVENTS)
  ...
  @KafkaListener(
      id = AllocationEventSubscriptions.INVENTORY_AVAILABILITY,
      topics = InventoryEventTopics.STOCK_EVENTS)
