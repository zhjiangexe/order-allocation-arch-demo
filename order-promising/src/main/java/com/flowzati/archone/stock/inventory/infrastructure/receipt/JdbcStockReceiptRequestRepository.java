package com.flowzati.archone.stock.inventory.infrastructure.receipt;

import com.flowzati.archone.stock.inventory.application.command.ConfirmStockReceiptCommand;
import com.flowzati.archone.stock.inventory.application.receipt.StockReceiptRequest;
import com.flowzati.archone.stock.inventory.application.receipt.StockReceiptRequestConflictException;
import com.flowzati.archone.stock.inventory.application.receipt.StockReceiptRequestRepository;
  ...
  private void requireCallerTransaction() {
    if (!TransactionSynchronizationManager.isActualTransactionActive()) {
      throw new IllegalStateException(
          "Stock receipt request claim requires an active caller transaction");
    }
  }
}
