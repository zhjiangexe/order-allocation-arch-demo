...
public class StockQuantController {
    ...
    public StockQuantController(GetStockQuantUsecase getStockQuantUsecase, BusinessClock appClock) {
     ...
     */
    @GetMapping
    public StockQuantResponse getStockInLocation(@RequestParam UUID ownerId, @RequestParam UUID locationId) {
