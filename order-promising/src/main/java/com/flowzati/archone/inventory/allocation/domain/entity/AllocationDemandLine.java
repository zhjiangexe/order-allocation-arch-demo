package com.flowzati.archone.inventory.allocation.domain.entity;

import java.util.UUID;

/** Allocation-owned demand line；source line id 只供追蹤，不作 core join key。 */
public record AllocationDemandLine(
        UUID id, UUID allocationDemandId, String sourceLineId, String skuCode, int quantity, int lineSequence) {
