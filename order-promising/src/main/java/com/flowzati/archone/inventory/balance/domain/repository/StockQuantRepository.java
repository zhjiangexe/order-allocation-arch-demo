package com.flowzati.archone.inventory.balance.domain.repository;
...
public interface StockQuantRepository {
     ...
     * 依據。
     */
    List<StockQuant> findAllocatableBatchesInFefoOrder(UUID ownerId, UUID locationId, String skuCode, LocalDate today);
     ...
     * 時的狀態。
     */
    Map<String, List<StockQuant>> findBatchesInLocation(UUID ownerId, UUID locationId);
