package com.flowzati.archone.inventory.allocation.infrastructure.messaging.producer;
...
import com.flowzati.archone.inventory.allocation.application.event.AllocationEventPublisher;
...
public class AllocationIntegrationEventPublisher implements AllocationEventPublisher {
    ...
    public void translate(OrderAllocationCompleted event) {
        OrderAllocatedIntegrationEvent integration =
                new OrderAllocatedIntegrationEvent(IdGenerator.nextId(), event.orderId(), event.allocatedAt());
