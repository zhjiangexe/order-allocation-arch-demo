...
public final class StockFixtures {
  ...
  public static StockQuant unexpiredBatch(
   ...
   * ——看起來像「沒存進去」，實際是「用錯鍵去查」。
   */
  public static java.util.Optional<StockQuant> reloadUnexpiredBatch(
      com.flowzati.archone.inventory.balance.domain.repository.StockQuantRepository repository,
      String skuCode) {
