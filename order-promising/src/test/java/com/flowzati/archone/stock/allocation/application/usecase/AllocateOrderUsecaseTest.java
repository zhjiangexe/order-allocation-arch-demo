...
import com.flowzati.archone.stock.allocation.application.demand.AllocationDemandAcceptance;
...
class AllocateOrderUsecaseTest {
  ...
  private static com.flowzati.archone.stock.movement.domain.aggregate.StockMove move(AllocationDemand demand) {
    return com.flowzati.archone.stock.movement.domain.aggregate.StockMove.confirmedForDemand(
