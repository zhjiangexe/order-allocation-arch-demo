...
import com.flowzati.archone.stock.domain.event.AllocationCommitted.CommittedAllocationMove;
import com.flowzati.archone.stock.domain.event.AllocationCommitted.CommittedBatchPick;
...
class OrderAllocationCompletionAdapterTest {
  ...
  void shouldPreserveOrderV1ContractMapping() {
    ...
    AllocationCommitted generic = new AllocationCommitted(
        ...
        uuid(11), uuid(12), uuid(13), requiredBy, 50, occurredAt,
        List.of(new CommittedAllocationMove(
            uuid(10), uuid(14), orderLineId.toString(), moveId, pickingId,
            "SKU-A", uuid(13), 5,
