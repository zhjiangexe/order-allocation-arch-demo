...
| 路徑 | 操作與限制 |
| --- | --- |
| `/orders` 訂單 | 多 SKU 建單、最近 20 筆訂單、手動更新及「查看履約」。最晚離倉時間必填，依瀏覽器本地時區輸入；release priority 預設 0，範圍 0～100。成功後開啟詳情。 |
...
詳情抽屜可由 URL 深連結恢復，關閉回原頁。分區顯示訂單、庫存作業、movement／批次、Shipment
