...
import com.flowzati.archone.logisticsdata.entrypoint.rest.response.FacilityResponse;
import com.flowzati.archone.logisticsdata.entrypoint.rest.response.OwnerResponse;
import com.flowzati.archone.logisticsdata.entrypoint.rest.response.ProductResponse;
import com.flowzati.archone.logisticsdata.entrypoint.rest.response.SkuResponse;
...
public class CatalogRest {
    ...
    public List<ProductResponse> listProducts(@PathVariable(name = "ownerId") UUID ownerId) {
    ...
    public List<FacilityResponse> listFacilities(@PathVariable(name = "ownerId") UUID ownerId) {
    ...
    public List<SkuResponse> listSkus(
            @PathVariable(name = "ownerId") UUID ownerId, @PathVariable(name = "productCode") String productCode) {
