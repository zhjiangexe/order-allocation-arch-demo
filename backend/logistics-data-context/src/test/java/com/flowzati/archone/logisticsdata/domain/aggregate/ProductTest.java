...
class ProductTest {
    ...
    void treatsTheSameProductCodeUnderTwoOwnersAsDistinct() {
        ...
        Product ambient = new Product(UUID.randomUUID(), OWNER_ID, "P-1", "烏龍茶", TemperatureZoneType.AMBIENT);
        Product frozen = new Product(UUID.randomUUID(), otherOwnerId, "P-1", "冷凍水餃", TemperatureZoneType.FROZEN);
    ...
    void rejectsMissingId() {
        assertThatThrownBy(() -> new Product(null, OWNER_ID, "P-1", "烏龍茶", TemperatureZoneType.AMBIENT))
    ...
    void rejectsMissingOwnerId() {
        assertThatThrownBy(() -> new Product(UUID.randomUUID(), null, "P-1", "烏龍茶", TemperatureZoneType.AMBIENT))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void rejectsBlankProductCode(String productCode) {
        assertThatThrownBy(
                        () -> new Product(UUID.randomUUID(), OWNER_ID, productCode, "烏龍茶", TemperatureZoneType.AMBIENT))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void rejectsBlankName(String name) {
        assertThatThrownBy(() -> new Product(UUID.randomUUID(), OWNER_ID, "P-1", name, TemperatureZoneType.AMBIENT))
                .isInstanceOf(IllegalArgumentException.class)
