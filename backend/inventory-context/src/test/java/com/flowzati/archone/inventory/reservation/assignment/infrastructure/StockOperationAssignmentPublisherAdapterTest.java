...
class StockOperationAssignmentPublisherAdapterTest {
    ...
    void mapsOrderAssignmentToExistingV3ContractAndRouting() {
        ...
        var adapter = new StockOperationAssignmentPublisherAdapter(integrationEventPublisher);
    ...
    void keepsNonOrderSourcesInsideInventoryUntilTheyHaveAnExplicitContract() {
        ...
        adapter.publish(result(MovementSourceType.TRANSFER, "transfer-1"));
