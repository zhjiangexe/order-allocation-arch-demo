...
@Repository
public class JdbcStockOperationAssignmentBacklogStore implements StockOperationAssignmentBacklogStore {

    private final JdbcClient jdbcClient;

    public JdbcStockOperationAssignmentBacklogStore(JdbcClient jdbcClient) {
