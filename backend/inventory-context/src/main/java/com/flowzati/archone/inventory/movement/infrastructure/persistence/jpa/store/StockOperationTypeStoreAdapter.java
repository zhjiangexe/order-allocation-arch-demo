...
@Repository
public class StockOperationTypeStoreAdapter implements StockOperationTypeStore {

    private final JpaStockOperationTypeRepository jpaStockOperationTypeRepository;

    public StockOperationTypeStoreAdapter(JpaStockOperationTypeRepository jpaStockOperationTypeRepository) {
