package com.flowzati.archone.inventory.movement.infrastructure.repository;
...
import com.flowzati.archone.inventory.movement.infrastructure.repository.jpa.JpaStockMoveLineRepository;
import com.flowzati.archone.inventory.movement.infrastructure.repository.jpa.JpaStockMoveRepository;
...
public class StockMoveRepositoryImpl implements StockMoveRepository {
    ...
    public StockMoveRepositoryImpl(
            JpaStockMoveRepository moveRepository, JpaStockMoveLineRepository moveLineRepository) {
    ...
    public List<StockMove> findByAllocationDemandId(UUID allocationDemandId) {
        return moveRepository.findByAllocationDemandIdOrderByAllocationDemandLineIdAsc(allocationDemandId).stream()
                .map(StockMoveMapper::toDomain)
                .toList();
    }
