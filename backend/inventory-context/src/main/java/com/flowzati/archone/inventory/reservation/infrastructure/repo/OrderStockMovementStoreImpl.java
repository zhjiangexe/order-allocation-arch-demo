...
import com.flowzati.archone.inventory.movement.application.command.RegisterStockOperationCommand.MovementLine;
...
@Component
public class OrderStockMovementStoreImpl implements OrderStockMovementStore {

    private final JpaOrderAllocationSourceRepository jpaOrderAllocationSourceRepository;

    public OrderStockMovementStoreImpl(JpaOrderAllocationSourceRepository jpaOrderAllocationSourceRepository) {
