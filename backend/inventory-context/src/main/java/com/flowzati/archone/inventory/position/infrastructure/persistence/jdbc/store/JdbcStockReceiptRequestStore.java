package com.flowzati.archone.inventory.position.infrastructure.persistence.jdbc.store;
...
@Repository
public class JdbcStockReceiptRequestStore implements StockReceiptRequestStore {
    ...
    public JdbcStockReceiptRequestStore(JdbcOperations jdbcOperations) {
