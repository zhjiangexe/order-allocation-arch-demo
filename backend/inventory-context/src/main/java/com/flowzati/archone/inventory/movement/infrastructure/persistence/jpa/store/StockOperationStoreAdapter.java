...
@Repository
public class StockOperationStoreAdapter implements StockOperationStore {

    private final JpaStockOperationRepository jpaStockOperationRepository;

    public StockOperationStoreAdapter(JpaStockOperationRepository jpaStockOperationRepository) {
