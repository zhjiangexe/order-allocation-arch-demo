...
@Repository
public class StockLocationStoreAdapter implements StockLocationStore {

    private final JpaStockLocationRepository jpaStockLocationRepository;

    public StockLocationStoreAdapter(JpaStockLocationRepository jpaStockLocationRepository) {
