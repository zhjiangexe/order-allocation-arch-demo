...
class AcceptCancellationRequestUsecaseTest {
    ...
    void newRequestPublishesOnce() {
        ...
        assertThat(usecase.accept(command)).isEqualTo(FulfillmentCancellationStatus.ACCEPTED);
    ...
    void replayDoesNotPublishAgain() {
        ...
        assertThat(usecase.accept(command)).isEqualTo(FulfillmentCancellationStatus.ALREADY_REQUESTED);
    ...
    void differentPayloadConflicts() {
        ...
        assertThat(usecase.accept(command)).isEqualTo(FulfillmentCancellationStatus.CONFLICT);
        verifyNoInteractions(publisher);
    }
}
