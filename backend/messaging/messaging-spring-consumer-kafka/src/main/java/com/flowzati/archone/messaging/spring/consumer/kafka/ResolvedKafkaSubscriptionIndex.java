...
final class ResolvedKafkaSubscriptionIndex {
    ...
    private ResolvedKafkaSubscriptionIndex(
            Map<String, ResolvedMessageSubscription> subscriptionsByDestination, String owner) {
        this.subscriptionsByDestination = subscriptionsByDestination;
        this.owner = owner;
    }

    static ResolvedKafkaSubscriptionIndex create(Collection<ResolvedMessageSubscription> subscriptions, String owner) {
