...
public final class ProducerObservationInterceptor implements MessageInterceptor {
    ...
    private final ThreadLocal<Deque<ObservationAttempt>> attempts = ThreadLocal.withInitial(ArrayDeque::new);
    ...
    public ProducerObservationInterceptor(
            ObservationRegistry observationRegistry, ProducerMessageObservationConvention customConvention) {
    ...
    public Message preSend(Message message, MessagePublicationContext publicationContext) {
        ...
        Observation observation = Observation.createNotStarted(
                customConvention, DEFAULT_CONVENTION, () -> observationContext, observationRegistry);
    ...
    @Override
    public void postSend(Message message, MessagePublicationContext publicationContext, Throwable failure) {
    ...
    private record ObservationAttempt(
            Observation observation, Observation.Scope scope, ProducerMessageObservationContext context) {}
}
