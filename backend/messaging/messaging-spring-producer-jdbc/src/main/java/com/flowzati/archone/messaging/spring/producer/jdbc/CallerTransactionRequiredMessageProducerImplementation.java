...
public final class CallerTransactionRequiredMessageProducerImplementation implements MessageProducerImplementation {
    ...
    public CallerTransactionRequiredMessageProducerImplementation(
            MessagingTransactionTemplate transactionTemplate, MessageProducerImplementation delegate) {
