...
class KafkaConsumerConfigurationTest {
    ...
    void fixesTheCombinedTransactionAttemptBudget() {
        assertThat(ConsumerFailurePolicy.LOCAL_OPTIMISTIC_RETRIES).isEqualTo(2);
        assertThat(ConsumerFailurePolicy.KAFKA_REDELIVERY_RETRIES).isEqualTo(4);
        assertThat(ConsumerFailurePolicy.MAX_OPTIMISTIC_TRANSACTION_ATTEMPTS).isEqualTo(15);
        assertThat(ConsumerFailurePolicy.MAX_TRANSIENT_INFRASTRUCTURE_PROCESSING_ATTEMPTS)
                .isEqualTo(5);
    }
