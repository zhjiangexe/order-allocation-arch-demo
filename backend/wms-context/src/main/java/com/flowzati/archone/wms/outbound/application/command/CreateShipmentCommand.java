...
public record CreateShipmentCommand(
    ...
    public CreateShipmentCommand {
        if (shipmentId == null || allocationId == null || orderId == null || ownerId == null || facilityId == null) {
        ...
        if (lines.stream().anyMatch(line -> line == null || !moveIds.add(line.moveId()))) {
            throw new IllegalArgumentException("Create shipment requires unique non-null allocation lines");
        }
