package com.flowzati.archone.wms.wave.domain.valueobject;
...
public record WavePlanningPolicy(
        UUID facilityId, Instant dispatchByCutoff, int maxShipments, int maxLines, int maxUnits) {
    ...
    public boolean canAdd(WaveCandidate candidate, int selectedShipments, int selectedLines, int selectedUnits) {
