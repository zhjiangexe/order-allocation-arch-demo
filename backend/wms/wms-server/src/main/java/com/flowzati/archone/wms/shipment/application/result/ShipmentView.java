...
import com.flowzati.archone.wms.picking.application.result.PickTaskView;
...
public record ShipmentView(
    ...
    public static ShipmentView from(Shipment shipment, PickingWork pickingWork) {
        List<PickTask> pickTasks = pickingWork == null ? List.of() : pickingWork.pickTasks();
