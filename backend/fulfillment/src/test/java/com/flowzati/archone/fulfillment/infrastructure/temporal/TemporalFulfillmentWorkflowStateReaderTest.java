...
class TemporalFulfillmentWorkflowStateReaderTest {
    ...
    private final TemporalFulfillmentWorkflowStateReader reader = new TemporalFulfillmentWorkflowStateReader(client);
    ...
    void returnsSnapshot() {
        ...
        assertThat(result.status()).isEqualTo(FulfillmentWorkflowQueryStatus.AVAILABLE);
    ...
    void distinguishesNotFoundFromServiceOutage() {
        ...
        var result = reader.find(ORDER_ID);
        assertThat(result.status()).isEqualTo(FulfillmentWorkflowQueryStatus.NOT_FOUND);
    ...
    void reportsExpectedTransportFailuresAsUnavailable(Status.Code code) {
        ...
        assertThat(reader.find(ORDER_ID).status()).isEqualTo(FulfillmentWorkflowQueryStatus.UNAVAILABLE);
    }
