...
class IntegrationEventJsonContractTest {
    ...
    private static Stream<Arguments> contracts() {
        return Stream.of(
                ...
                Arguments.of(
                        "stock-operation-lifecycle-v1.json",
                        new StockOperationLifecycleIntegrationEvent(
                                EVENT_ID,
                                ALLOCATION_ID,
                                PICKING_TYPE_ID,
                                "ORDER",
                                ORDER_ID.toString(),
                                "PRIMARY",
                                StockOperationLifecycleIntegrationEvent.LifecycleAction.RELEASED,
                                java.util.List.of(new StockOperationLifecycleIntegrationEvent.MoveSnapshot(
                                        MOVE_ID,
                                        ORDER_LINE_ID.toString(),
                                        "SKU-1",
                                        3,
                                        java.util.List.of(new StockOperationLifecycleIntegrationEvent.BatchSnapshot(
                                                STOCK_QUANT_ID, 3)))),
                                OCCURRED_AT),
                ...
                Arguments.of(
                        ...
                        new OrderAllocationCommittedIntegrationEvent(
                                ...
                                LOCATION_ID,
                                DESTINATION_ID,
                                java.util.List.of(new OrderAllocationCommittedIntegrationEvent.AssignedMove(
                                        ORDER_LINE_ID,
                                        MOVE_ID,
                                        "SKU-1",
                                        3,
                                        java.util.List.of(new OrderAllocationCommittedIntegrationEvent.BatchPick(
                                                STOCK_QUANT_ID, 3)))),
