...
/** WMS 已將 Shipment custody 交給承運人，Inventory 可以正式完成對應出庫。 */
public final class ShipmentHandedOverForFulfillmentIntegrationEvent extends IntegrationEvent {

    public static final String EVENT_TYPE = "ShipmentHandedOverForFulfillmentIntegrationEvent";
    ...
    @JsonCreator
    public ShipmentHandedOverForFulfillmentIntegrationEvent(
