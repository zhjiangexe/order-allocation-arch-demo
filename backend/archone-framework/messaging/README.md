...
| Application 角色 | 依賴 |
|---|---|
| 只發布訊息 | `:archone-framework:messaging:messaging-spring-producer-starter` |
| 只消費訊息 | `:archone-framework:messaging:messaging-spring-consumer-starter` |
| 同時發布與消費 | `:archone-framework:messaging:messaging-spring-boot-starter` |
