...
@ConditionalOnProperty(prefix = "archone.messaging.consumer.kafka", name = "enabled", matchIfMissing = true)
...
public class MessagingKafkaConsumerAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    MessageHeadersDecoder kafkaMessageHeadersDecoder(ObjectProvider<ObjectMapper> objectMappers) {
    ...
    MessageConsumer messageConsumer(
        ...
        return new MessageConsumerImpl(implementation, channelMapping, consumerGroupMapping, decorators);
    }
}
