...
public final class TypeBasedMessageFailureClassifier implements MessageFailureClassifier {
    ...
    public static final class Builder {
        ...
        public Builder retryable(Class<? extends Throwable> failureType, MessageFailureCategory category) {
            return classify(failureType, MessageFailureClassification.retryable(category));
        }

        public Builder nonRetryable(Class<? extends Throwable> failureType, MessageFailureCategory category) {
            return classify(failureType, MessageFailureClassification.nonRetryable(category));
        }

        public Builder classify(Class<? extends Throwable> failureType, MessageFailureClassification classification) {
            ...
            MessageFailureClassification previous = classifications.putIfAbsent(failureType, classification);
            if (previous != null) {
        ...
        public Builder fallback(MessageFailureClassification fallback) {
            this.fallback = Objects.requireNonNull(fallback, "Fallback message failure classification is required");
            return this;
        }
